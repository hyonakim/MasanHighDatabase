...
var _parse_info = require('./parse_info');

_jquery2['default'].ajaxSetup({
  headers: {
    'X-Parse-Application-Id': _parse_info.AppKey,
    'X-Parse-REST-API-Key': _parse_info.RESTKey
  }
});

},{"./parse_info":3,"jquery":14}],2:[function(require,module,exports){
'use strict';
...
var AppKey = 'RTTjsWNWd02h4210YyNvr5M5MjgfYegzJymTrL9i';
var RESTKey = 'n80zLH0k9VsN5walWobASI7rxMUQItiDCqqVkkbX';
var AppURL = 'https://api.parse.com/1/classes/MasanHigh';
...
},{"./people":5,"./person":6}],5:[function(require,module,exports){
'use strict';
...
},{"../parse_info":3,"./person":6,"backbone":13}],6:[function(require,module,exports){
'use strict';
...
},{"../parse_info":3,"backbone":13}],7:[function(require,module,exports){
'use strict';
...
exports['default'] = _backbone2['default'].Router.extend({
  ...
  initialize: function initialize(appElement) {
    ...
    this.$el.on('click', '.person-list-item', function (event) {
      ...
      var personId = $div.data('person-id');
      _this.navigate('person/' + personId, { trigger: true });
    });

    this.$el.on('click', '.backBtn', function (event) {
      var $button = (0, _jquery2['default'])(event.currentTarget);
      var route = $button.data('to');
      _this.navigate(route, { trigger: true });
    });

    this.$el.on('click', '.addStudent', function (event) {
      var $button = (0, _jquery2['default'])(event.currentTarget);
      var route = $button.data('to');
      _this.navigate('newPerson', { trigger: true });
    });

    this.$el.on('click', '.createStudent', function (event) {
  ...
  showSpecificPerson: function showSpecificPerson(id) {
    var _this3 = this;
...
},{"./resources":4,"./views":9,"backbone":13,"jquery":14}],8:[function(require,module,exports){
"use strict";
...
exports.Person = _person2['default'];
exports.People = _people2['default'];
exports.AddNew = _add_new2['default'];
exports.Spinner = _spinner2['default'];

},{"./add_new":8,"./people":10,"./person":11,"./spinner":12}],10:[function(require,module,exports){
'use strict';
